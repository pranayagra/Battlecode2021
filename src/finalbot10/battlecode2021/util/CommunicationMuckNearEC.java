...
public class CommunicationMuckNearEC {

    /* DONE */

    public static final int FLAG_CODE = 0b111;

    public static final int LOCATION_DATA_NBITS = 7;
    public static final int LOCATION_DATA_BITMASK = (1 << LOCATION_DATA_NBITS) - 1;

    private static final int HEALTH_MULTIPLIER = 15;

    /* SCHEMA: 3 bits code | 1 bit skippedQueue | 1 bit last flag | 5 bits health (value * 15) | 14 bits locationdata */
    public static int encodeMUCKNearSlanderers(
            boolean isUrgent, boolean isLastFlag, int health, MapLocation locationData) {
